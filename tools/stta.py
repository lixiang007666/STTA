...
from mmseg.apis import multi_gpu_test, single_gpu_test, single_gpu_stta
...
def main():
    ...
    if True:#True: #args.aug_test:
        if cfg.data.test.type in ['Bratst2Dataset']:
            # hard code index
            cfg.data.test.pipeline[1].img_ratios = [
                0.5, 0.75, 1.0, 1.25, 1.5, 1.75, 2.0
            ]
            cfg.data.test.pipeline[1].flip = True
        elif cfg.data.test.type == 'BraTsDataset':
            # hard code index
            cfg.data.test.pipeline[1].img_ratios = [
    ...
    for i in range(1):
        ...
        for dataset, data_loader in zip(datasets, data_loaders):
            outputs = single_gpu_stta(model, data_loader, args.show, args.show_dir,
